...
/**
 * Servlet implementation class ServletConfimadorIdade
 */
@WebServlet(
		name = "ServletConfimadorIdade",
		urlPatterns = {"/ConfirmaIdade"}
		)
public class ServletConfimadorIdade extends HttpServlet {
	private static final long serialVersionUID = 1L;
    private ServletContext contexto;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletConfimadorIdade() {
        super();
